...
#define fsigndiff(x, y) (x * (y / mpfr::abs(y)) < Scalar(0.))
...
namespace LBFGSpp { 
    ...
    template <typename Scalar> 
        Scalar LineSearchMT<Scalar>::cubic_minimizer(Scalar u, Scalar fu, Scalar du, Scalar v, Scalar fv, Scalar dv) 
        {
            /**
    ...
    template <typename Scalar> 
        Scalar LineSearchMT<Scalar>::cubic_minimizer2(Scalar u, Scalar fu, Scalar du, Scalar v, Scalar fv, Scalar dv, Scalar xmin, Scalar xmax)
        {
            /**
             * Find a minimizer of an interpolated cubic function.
             *  cm      The minimizer of the interpolated cubic.
    ...
    template <typename Scalar> 
        Scalar LineSearchMT<Scalar>::quadr_minimizer(Scalar u, Scalar fu, Scalar du, Scalar v, Scalar fv)
        {
            /**
    ...
    template <typename Scalar> 
        Scalar LineSearchMT<Scalar>::quadr_minimizer2(Scalar u, Scalar du, Scalar v, Scalar dv) 
        {
            /**
             * Find a minimizer of an interpolated quadratic function.
             *  qm      The minimizer of the interpolated quadratic.
    ...
    template <typename Scalar> 
        int LineSearchMT<Scalar>::update_trial_interval(
                Scalar &x,
                Scalar &fx,
                Scalar &dx,
                Scalar &y,
    ...
    template <typename Scalar> 
        template <typename Foo>
        void LineSearchMT<Scalar>::MoreThuente(
                Foo& f,
                Scalar& fout,
                Vector& x,
                Vector& grad,
